...
cf_resources=$(
  jq -n \
    ...
    '
    {
      "database": {"instances": 1, "internet_connected": $internet_connected},
      "blobstore": {"instances": 0, "internet_connected": $internet_connected},
      "control": {"instances": 1, "internet_connected": $internet_connected},
      "compute": {"instances": 2, "internet_connected": $internet_connected},
      ...
      "mysql_monitor": {"instances": 1, "internet_connected": $internet_connected},
